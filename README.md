# Extra Trees Time Step Classifier in Scikit-learn

Extra Trees Time Step Classification Model in Scikit-learn as per Ready Tensor specifications.
...
- A **Extra Trees Time Step Classification** model built using **Scikit-learn**
