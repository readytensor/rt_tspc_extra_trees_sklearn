...
class TimeStepClassifier:
    """Extra Trees TimeStepClassifier.

    This class provides a consistent interface that can be used with other
    TimeStepClassifier models.
    """
    MODEL_NAME = "Extra_Trees_TimeStepClassifier"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Construct a new Extra Trees TimeStepClassifier.
    ...
    def build_model(self) -> ExtraTreesClassifier:
        """Build a new Extra Trees Classifier."""
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the Extra Trees TimeStepClassifier to disk.
    ...
    def load(cls, model_dir_path: str) -> "TimeStepClassifier":
        """Load the Extra Trees TimeStepClassifier from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            TimeStepClassifier: A new instance of the loaded Extra Trees TimeStepClassifier.
        """
